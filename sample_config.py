...
def get_user_list(config, key):
    with open("{}/Villain/{}".format(os.getcwd(), config), "r") as json_file:
...
class Config(object):
    ...
    OWNER_USERNAME = "Akborana1"
    SUPPORT_CHAT = "AKBORANA"  # Your own group for support, do not add the @
    JOIN_LOGGER = (
        -1001253661229
...
#MAIN PY AND SAMPLE KO RECHECK KRNA HAI TEAM AKAY