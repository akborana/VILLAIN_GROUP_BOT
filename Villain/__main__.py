...
from Villain.modules import ALL_MODULES
...
from Villain.modules.helper_funcs.misc import paginate_modules
from Villain.modules.helper_funcs.readable_time import get_readable_time

PM_START_TEXT = """
Hello there, I'm [Villian](https://telegra.ph/file/473cc17913393959e0667.jpg)
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="💫 Add Daisy to your group 💫", url="t.me/Villain_Robot?startgroup=true"
        ),
    ],
]
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Villain.modules." + module_name)
...
def Villain_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [DEV CHANNEL](https://t.me/akborana).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            ...
            f"\n✪ Always try to keep credits, so \n  This hardwork is done by @AKBORANA team AKAY spending many sleepless nights.. So, Respect it."
            f"\n✪ Some modules in this bot is owned by different authors, So, \n  All credits goes to only DEVIL and Akay team\n  Also for <b>Paul Larson for Marie</b>."
