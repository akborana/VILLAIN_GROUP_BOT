...
# from Villain.modules.sql import warns_sql as warnssql
import Villain.modules.sql.blacklist_sql as blacklistsql

# from Villain.modules.sql import cust_filters_sql as filtersql
# import Villain.modules.sql.welcome_sql as welcsql
import Villain.modules.sql.locks_sql as locksql
import Villain.modules.sql.notes_sql as sql

# from Villain.modules.rules import get_rules
import Villain.modules.sql.rules_sql as rulessql
from Villain import JOIN_LOGGER, LOGGER, OWNER_ID, dispatcher
from Villain.__main__ import DATA_IMPORT
...
from Villain.modules.sql import disable_sql as disabledsql
...
def import_data(update, context):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        ...
        try:
            ...
            msg.reply_text(
                "An error occurred while recovering your data. The process failed. If you experience a problem with this, please take it to @AKBORANA DEV @AKBORANA1"
            )
