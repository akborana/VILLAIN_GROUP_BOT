...
TRUTH = (
    ...
    "TU CHUTIYA HAI ?",
    "BSDKE TERI FIRST GF KA NAAM ?",
    "TRRI EX NE TERA KYU KATA THA?",
    "PORN KITNE TIME DEKTE HO?",
    "KOI CHUTIYAPA TU BATAO TUMARI?",
    "KISI KO SABSE JYDA PASAND KRTE HO MOM DAD AUR FAMILY KE ALAVA GANDU?",
    "TUM KABHI APNE DOST SE JALAN FEEL KIYE HO ?",
    "Would you cheat on your boyfriend/GIRLFRIEND for a rich guy?",
    "Kitne bf/gf hi tumare",
    "Ek truth me bolu join @Akborana1",
    "SUNO KITNO KO PROPOSE KIYA HAI ?",
    ...
    "KITNE TIME SE BRUSH NA KIYA DAATO ME ?",
    "BINA SHOWER KE KITNE DIN RAH SAKTA HAI?",
)
...
ABUSE_STRINGS = (
    "Abe o ab teri gand me danda maru",
    "Abe o gandu tere baap Jerry ya AKAY ko bulayu",
    "Teri gand faad ke godam bna duga",
    "Tume dek kr muje apne lode ki yaad aa jati hi ",
    "oye OP TOPI KE CHODE BAAP SE PANGE LEGA BAAP MUH ME LUND DE DEGA"
    "Owww ... Such a stupid idiot.",
    "PIKAR PHONE NA CHALA .",
    "GHAR JAA KR SO JAA VARNA JERRY AA JAYEGA.",
    "COMMND NOT FOUND JUST LIKE YOUR BRAIN🤣😂.",
    "Do you realize you are making a fool of yourself? Apparently not.",
    "TUM ISSE ACHI GANDU PANTI KR SAKTE HO.",
    "Bot rule 544 section 9 prevents me from replying to stupid humans like you.",
    "Sorry, we do not sell brains.",
    "Believe me JERRY you are not normal.",
    "I bet your brain feels as good as new, seeing that you never use it.",
    "If I wanted to kill myself I'd climb your ego and jump to your IQ.",
    "Zombies eat brains... you're safe TUJME TO BRAIN HI NA HAI.",
    "KESI HAI MAJBURI JO HAR AAKH HUYI NAM KYU KR RHA TU ESI CHUTIYE WALI HARKAT AB KESE HASEGE HM.",
    "Come back and talk to me when your I.Q. exceeds your age.",
    "I'm not saying you're stupid, I'm just saying you've got bad luck when it comes to thinking.",
    "TUM THODI KAM BACKCHODI KRO MUJE SOCHNA PADTA HAI KONSI GALI DU",
    "Papa Bol bhochike",
    "Ab tak kitno ka liya hai",
    "DEK VESE TO ME BAHUT SIDHA BOT HU \n BUT AGR BIN MTLB MERE PANGE LIYE \n TO SOCIAL MEDIA TO CHOD \n Villain😈 MAA CH+D DEGA TERE REAL LIFE KI \n #AKAY",
    "DEK ENGLISH ME ABUSE THODA KAM HAI BUT ME TO DESI HU GAND FAAD DETA HH",
    "DUD MANGOGE KHIR DEGE \n Villain se pange loge gand tod dege \n chir dege vo purana ho gya",
    "One shayri for you dhayan se sunna \n Machli jal ki raani hai \n jeevan uska pani hai +dhayan se padna+ machli jal ki raani hai jeevan uska paani hai \n itna dhayan se kya pad rha hai \n bsdke gand marwani hai #AKAY ",
    "KYA BHOK RHA HAI BE .",
    "TU KR BACKCHODI ME JA RHA AUR NA DEKHA JAYEGA.",
    "IN BHAI SAHAB KO KOI TROFEE DO BACKCHOD NO. 1.",
    "JA PAD VARNA AAMIR KI JAGH TERA ROAST KRWA DUGA CARRY SE.",
    "KONSE PLANET SE AAYA HAI TU?",
    "Brains aren't everything. In your case they're nothing.",
    "Ordinarily people live and learn. You just live BECAUSE LEARN KE LIYE BRAIN BHI CHAYIYE.",
    "I don't know what makes you so stupid, but it really works.",
    "Keep talking, someday you'll say something intelligent! (I doubt it though)",
    "Shock me, say something intelligent.",
    "Your IQ's lower than your shoe size.",
    "AB BS ME MARNE JA RHA HU YA HAS HAS KE MAR JAYUGA.",
    "BHAI TU KABHI MENTAL HOSPITAL GYA HAI.",
    "TUJE DEK KR TARAS AATA HAI BUT KYA KRU ME APNA BOT TO NA DE SAKTA HU NA.",
    "I'm sorry I hurt your feelings when I called you stupid. I thought you already knew that.",
    "BHAI EK BAR KHANA KHA KR DEK SHYD TU THEEK HO JAYE.",
    "RAT MARNE KI DAWAI SO JA BE.",
    "KYU HMESHA KE LIYE SONA CHAHTA HAI.",
    ...
    "Teri gand me khujli hai kya lode",
    "Kya be lawde tere Baap AKAY ko bulayu",
    "Jhaat ke baal aukat bna gand faad duga",
    "If you think you are bad so you know akay your dad",
    "Bhag jaa bhosdike",
...
GBUN = (
    ...
    "Ek bar maaf kr do is gandu ko",
    "Bahut serious matter hai To bulayu Akay ko",
)
...
GBAM_REASON = (
    ...
    "sasta hexa playur",
    "sasta tiktokur💃🏾",
    "sasta membor of team 07",
    "chutiye vp ka supporter",
    "sasta selmon boi",
